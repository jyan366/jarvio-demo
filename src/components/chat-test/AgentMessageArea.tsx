              ...
              {!group[0].isUser && <>
                  ...
                  {group.map(message => <div key={message.id} className="flex mb-4 gap-2">
                      ...
                      minute: '2-digit'
                        ...
                        {message.isLoading && <div className="bg-[#EAE6FF] border border-[#9b87f5]/30 rounded-lg p-3 mb-1 cursor-pointer" onClick={() => message.stepNumber && onStepClick && onStepClick(message.stepNumber - 1)}>
                        ...
                        {/* Step completion box */}
                        {message.isStepCompletion && message.stepNumber && <div className="bg-[#EAE6FF] border border-[#9b87f5]/30 rounded-lg p-3 mt-2 cursor-pointer" onClick={() => message.stepNumber && onStepClick && onStepClick(message.stepNumber - 1)}>
