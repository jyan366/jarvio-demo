...
export function ReviewsDialog({ open, onOpenChange, productName }: ReviewsDialogProps) {
  ...
  // Comprehensive mock reviews data with varied sentiments and topics
        ...
        <div className="space-y-8 my-6">
          ...
          <section>
            ...
            <Card className="p-4 bg-blue-50">
              <p className="text-base leading-relaxed text-blue-900 whitespace-pre-line">{reviewSummary}</p>
            </Card>
          </section>
